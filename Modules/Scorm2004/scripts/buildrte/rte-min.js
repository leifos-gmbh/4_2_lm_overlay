...
function save_global_objectives(){if(this.config.sequencing_enabled){var go2save=toJSONString(this.adl_seq_utilities);if(go2save!=saved_global_objectives){var iCounter=0,oObj;for(oObj in this.adl_seq_utilities.measure)iCounter++;for(oObj in this.adl_seq_utilities.satisfied)iCounter++;for(oObj in this.adl_seq_utilities.status)iCounter++;if(iCounter>0){var result=this.config.gobjective_url?sendJSONRequest(this.config.gobjective_url,this.adl_seq_utilities):{};}
