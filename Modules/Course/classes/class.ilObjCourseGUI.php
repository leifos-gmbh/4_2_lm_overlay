...
* $Id: class.ilObjCourseGUI.php 47951 2014-02-14 14:38:33Z jluetzen $
*
	...
	*/
	...
	{		
		...
		else
		{
			...
			$crs_start = $crs_start->getStartObjects();
			foreach($_POST['starter'] as $starter_id)
			{
				$ref_id = $crs_start[$starter_id]["item_ref_id"];
				$obj_id = ilObject::_lookupObjId($ref_id);
				$title = ilObject::_lookupTitle($obj_id);
				$cgui->addItem("starter[]", $starter_id, $title);
			}
...
//echo "1";
	...
	*/
		...
		$a_abo_status, $a_course_ref_id, $a_course_obj_id, $a_parent_ref_id = 0)
	{
		...
		if ($activation != "")
		{
			$lng->loadLanguageModule("crs"); // #12774
