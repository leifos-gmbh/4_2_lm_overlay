...
* @version $Id: class.ilObjCourseAccess.php 38103 2012-11-08 13:36:05Z jluetzen $
*
*/
class ilObjCourseAccess extends ilObjectAccess
{
	...
	*/
	 ...
	 * @param bool parse member view mode
	 * @return boolean
	 */
	public static function _isActivated($a_obj_id, $a_mind_member_view = true)
	{
		global $ilDB;
	...
	{
		return !self::_isActivated($a_obj_id, false);
	}
