...
* @version $Id: class.ilObjFile.php 50218 2014-05-21 10:02:47Z mjansen $
*
* @ingroup ModulesFile
*/
...
//echo "-".$a_element."-";
	...
	*/
	protected function doRead()
	{
		...
		// endriss-patch: begin
		$this->enablePreDownloadHook($row->pre_download_hook);
		// endriss-patch: end
	...
	*/
	protected function doUpdate()
	{
		...
		$q = "UPDATE file_data SET file_name = ".$ilDB->quote($this->getFileName() ,'text').
			...
			// endriss-patch: begin
			", pre_download_hook = ".$ilDB->quote((int)$this->isPreDownloadHookEnabled() ,'integer')." ".
			// endriss-patch: end
	...
	*/
	...
	{	
		...
		{
			// endriss-patch: begin
			if($this->isPreDownloadHookEnabled())
			{
				$pre_download_hook_class_name = 'ilFilePreDownloadHook';
				$pre_download_hook_path = "./Customizing/clients/".CLIENT_ID."/file/class.".$pre_download_hook_class_name.".php";
				if(!is_file($pre_download_hook_path))
				{
					$pre_download_hook_path = "./Customizing/global/file/class.".$pre_download_hook_class_name.".php";
				}
				
				if(is_file($pre_download_hook_path))
				{
					require_once $pre_download_hook_path;
					$hook = new $pre_download_hook_class_name();
					$hook->invoke($this, $file);
				}
			}
			// endriss-patch: end
...
*/
	...
	*/
	...
	// endriss-patch: begin
	protected $use_pre_download_hook = false;
	public function enablePreDownloadHook($status = true)
	{
		$this->use_pre_download_hook = $status;
	}
	public function isPreDownloadHookEnabled()
	{
		return $this->use_pre_download_hook;
	}
	// endriss-patch: end
} // END class.ilObjFile
?>
