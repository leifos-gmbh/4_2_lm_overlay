...
* @version $Id: class.ilObjTest.php 45932 2013-10-31 17:09:26Z mbecker $
*
...
*/
	...
	*/
	...
	function getUnfilteredEvaluationData()
	{
		...
		while ($row = $ilDB->fetchAssoc($result))
		{
			$data->getParticipant($row["active_fi"])->getPass($row["pass"])->addAnsweredQuestion($row["question_fi"], $row["maxpoints"], $row["points"]);
		}
