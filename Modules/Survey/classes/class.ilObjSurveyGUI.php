...
* @version  $Id: class.ilObjSurveyGUI.php 48029 2014-02-19 11:14:56Z jluetzen $
*
  ...
  function handleWriteAccess()
	...
	*/
	...
	{		
		...
		$txt = array($this->lng->txt("mailparticipantdata_placeholder"));
		foreach($placeholders as $placeholder => $caption)
		{
			$txt[] = "[".strtoupper($placeholder)."]: ".$this->lng->txt($caption);
		}
		$txt = implode("<br />", $txt);		
		$participantdatainfo = new ilNonEditableValueGUI("", "", true);
	...
	function propertiesObject(ilPropertyFormGUI $a_form = null)
	{
		...
		{			
			...
			$message = "<div style=\"margin-top:10px\">".
				$tpl->getMessageHTML(sprintf($this->lng->txt("survey_using_template"), 
