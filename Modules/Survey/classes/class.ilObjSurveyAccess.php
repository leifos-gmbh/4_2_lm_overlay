...
* @version $Id: class.ilObjSurveyAccess.php 37934 2012-10-29 15:24:37Z jluetzen $
*
...
class ilObjSurveyAccess extends ilObjectAccess
{
	...
	*/
	function _checkAccess($a_cmd, $a_permission, $a_ref_id, $a_obj_id, $a_user_id = "")
	{
		...
		{
			case "visible":
				$active = ilObjSurveyAccess::_lookupOnline($a_obj_id);			
			...
			case "read":	
				...
				if(!ilObjSurveyAccess::_lookupOnline($a_obj_id))
				{
					return false;
				}
				break;
