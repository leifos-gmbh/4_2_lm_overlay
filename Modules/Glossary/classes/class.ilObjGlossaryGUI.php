...
* @version $Id: class.ilObjGlossaryGUI.php 33686 2012-03-12 16:15:47Z jluetzen $
*
...
//echo $this->tpl->get();
	...
	*/
	function confirmTermDeletion()
	{
		...
		$buttons = array("deleteTerms"  => $this->lng->txt("confirm"),
			 "cancelTermDeletion"  => $this->lng->txt("cancel"));
		$this->tpl->setVariable("IMG_ARROW", ilUtil::getImagePath("arrow_downright.gif"));
		foreach($buttons as $name => $value)
		{
			$this->tpl->setCurrentBlock("operation_btn");
