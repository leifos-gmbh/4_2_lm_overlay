...
* $Id: class.ilObjForumGUI.php 44698 2013-09-10 15:13:58Z mjansen $
*
...
class ilObjForumGUI extends ilObjectGUI
{
	...
	{
		if(!is_array($_SESSION['frm']))
		{
			$_SESSION['frm'] = array();
		}

		if(isset($_GET['thr_pk']) && !is_array($_SESSION['frm'][(int)$_GET['thr_pk']]))
		{
			$_SESSION['frm'][(int)$_GET['thr_pk']] = array();
		}
	}
	...
	function getContent()
	{
		...
		if ($topicData)
		{
			...
			if ($thrNum > 0)
			{
				...
				if($ilUser->getId() != ANONYMOUS_USER_ID && $this->ilias->getSetting('forum_notification') == 1)
				{
...
// member tab
	...
	*/
	...
	{
		global $ilUser, $rbacsystem, $ilClientIniFile;
...
/*
	...
	*/
	...
	{
		global $ilUser, $rbacsystem, $ilias, $ilClientIniFile;
