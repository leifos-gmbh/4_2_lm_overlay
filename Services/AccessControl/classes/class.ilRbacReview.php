...
* 
* @version $Id: class.ilRbacReview.php 44361 2013-08-22 08:22:02Z smeyer $
* 
...
class ilRbacReview
{
	...
	*/
	...
	/*
	 * Check if role is local role of a role folder
	 */
	public function isLocalRole($a_role_id, $a_role_folder_id)
	{
		global $ilDB;

		$query = 'SELECT assign FROM rbac_fa '.
			'WHERE rol_id = '.$ilDB->quote($a_role_id,'integer').' '.
			'AND parent = '.$ilDB->quote($a_role_folder_id,'integer');
		$res = $ilDB->query($query);
		$row = $res->fetchRow(DB_FETCHMODE_OBJECT);
