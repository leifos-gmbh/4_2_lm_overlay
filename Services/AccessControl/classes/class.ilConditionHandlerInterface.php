...
* @version $Id: class.ilConditionHandlerInterface.php 34647 2012-05-14 15:21:02Z smeyer $
...
class ilConditionHandlerInterface
{
	...
	*/
	...
	{		
		...
		$cgui->setHeaderText($this->lng->txt("condition_delete_sure"));
		...
		foreach($_POST['conditions'] as $condition_id)
		{
			...
			$cgui->addItem("conditions[]", $condition_id, $title);
		}
