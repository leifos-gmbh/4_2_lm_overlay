...
* @version $Id: class.ilMail.php 41653 2013-04-23 08:56:05Z smeyer $
*
*/
...
//@todo check rcp pear validation
	...
	*/
	...
	public static function _usePearMail()
	{
		...
		$result = false;
		if ($ilias->getSetting('pear_mail_enable', 0))
		{
			...
			else 
			{
				...
				$ilias->setSetting('pear_mail_enable', 0);
			}
		}
		return $result;
	}
	...
	public static function _getIliasMailerName()
	{
		...
		if(strlen($ilSetting->get('short_inst_name')))
		{
