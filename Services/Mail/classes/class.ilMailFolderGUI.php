...
class ilMailFolderGUI
{
	...
	*/
	...
	public function addSubfolderCommands($check_uf = false)
	{
		...
		if('tree' != $_SESSION[ilMailGUI::VIEWMODE_SESSION_KEY])
		{
	...
	*/
	public function showFolder($a_show_confirmation = false)
	{
		...
		if(!isset($_SESSION[ilMailGUI::VIEWMODE_SESSION_KEY]) || 'tree' != $_SESSION[ilMailGUI::VIEWMODE_SESSION_KEY])
		{
	...
	public function deleteSubfolder($a_show_confirm = true)
	{
		if($a_show_confirm)
		{
			$sub_folder = $this->mbox->getFolderData($_GET['mobj_id']);
			...
			$oConfirmationGUI->addItem('', '', $sub_folder['title']);
