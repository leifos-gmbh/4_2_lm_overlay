...
* @version $Id: class.ilDBUpdate.php 50217 2014-05-21 09:57:50Z mjansen $
* @ingroup ServicesDatabase
*/
class ilDBUpdate
{
	// CUSTOM DBUPDATE PATCH BEGIN
	const CUSTOM_NAME = 'endriss';
	// CUSTOM DBUPDATE PATCH END
...
//				$this->initStep($i);	// nothings happens here
	...
	public function readCustomUpdatesInfo($a_force = false)
	{
		...
		$custom_updates_file = $this->PATH."setup/sql/dbupdate_custom_".self::CUSTOM_NAME.".php";
