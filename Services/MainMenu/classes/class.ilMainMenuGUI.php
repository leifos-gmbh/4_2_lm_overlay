...
*
* @author Alex Killing
* @version $Id: class.ilMainMenuGUI.php 50231 2014-05-21 15:08:20Z mjansen $
*/
class ilMainMenuGUI
{
	/**
	...
	function setTemplateVars()
	{
		...
		if (!$this->small)
		{
			...
			else
			{
				...
				global $tpl;
				// endriss-patch: begin
				# Changed for Adobe Connect Plugin rs 18.06.2012
				# if ($chatSettings->get('chat_enabled') && $notificationSettings->get('enable_osd')) {
				if ($notificationSettings->get('enable_osd')) {
				// endriss-patch: end
