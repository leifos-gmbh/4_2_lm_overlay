...
* @version $Id: class.ilInfoScreenGUI.php 33142 2012-02-13 09:27:37Z smeyer $
*
...
class ilInfoScreenGUI
{
	...
	* set a form action
	*/
	function setFormAction($a_form_action, $a_form_target = '')
	{
		$this->form_action = $a_form_action;
		$this->form_target = $a_form_target;
	}
	...
	*/
	function getHTML()
	{
		...
		{
			if(strlen($this->form_target))
			{
				$tpl->setCurrentBlock('formtarg');
				$tpl->setVariable('FORMTARGET',$this->form_target);
				$tpl->parseCurrentBlock();
			}
